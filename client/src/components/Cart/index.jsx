    ...
    <div className={styles.cartContainer}>
      ...
      {cartItems && cartOpen && (
        <div className={styles.cart}>
          ...
          <a className="btn btn-primary" href="https://www.freecodecamp.org/" style={{marginRight: '28%',marginLeft:'32%', marginBottom: '20px', background: 'rgb(204,156,73)',
background: 'linear-gradient(90deg, rgba(204,156,73,1) 0%, rgba(242,117,0,1) 100%)' }}>Confirmar pedido</a>
        </div>
      )}
    </div>
  );
